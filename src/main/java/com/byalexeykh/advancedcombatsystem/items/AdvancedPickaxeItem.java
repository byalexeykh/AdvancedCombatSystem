...
public class AdvancedPickaxeItem extends AdvancedToolItem {
    ...
    public AdvancedPickaxeItem(IItemTier tier, float attackDamageIn, float angleIn, float rangeIn, float neededBackswingTicksIn, float minBackswingTicksIn, int maxComboNumIn, Properties builder) {
