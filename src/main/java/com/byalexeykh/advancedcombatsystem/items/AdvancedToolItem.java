...
public class AdvancedToolItem extends AdvancedTieredItem {
    private final Set<Block> effectiveBlocks;
    protected final float efficiency;
    private final float attackDamage;

    public AdvancedToolItem(IItemTier tier, ACSAttributesContainer attrContainer, float attackDamage, Set<Block> effectiveBlocks, Properties builder) {
