...
public class AdvancedAxeItem extends AdvancedToolItem {
    ...
    public AdvancedAxeItem(IItemTier tier, float attackDamageIn, float angleIn, float rangeIn, float neededBackswingTicksIn, float minBackswingTicksIn, int maxComboNumIn, double speedReduceModifierIn, Properties builder) {
